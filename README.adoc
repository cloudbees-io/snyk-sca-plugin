...
NOTE: In the Java example above, `--all-projects` scans all Maven modules in a multi-module project, and `-- -s /cloudbees/workspace/settings.xml` passes Maven-specific arguments to use a custom settings file.
    ...
    steps:
      ...
      - id: print-outputs-from-snyk-sca-step
        ...
        run: |
            ...
            echo "Policy subject: ${{steps.snyk-sca-step.outputs.policy-subject}}"
...
jobs:
  job1:
    outputs:
      ...
      snyk-sca-job-output-policy-subject: ${{ steps.snyk-sca-step.outputs.policy-subject }}
    steps:
      - name: Check Out Source Code
        uses: cloudbees-io/checkout@v1
        with:
    ...
    steps:
      - id: print-outputs-from-job1
        ...
        run: |
          ...
          echo "Policy subject: ${{ needs.job1.outputs.snyk-sca-job-output-policy-subject }}"
